<?php
/*
 * Файл local/components/kolim/light.news/component.php
 */
...
if ($arParams['SEF_MODE'] == 'Y') {
    ...
    $arVariables = array();
     ...
     // Определим имя файла (list, element), которому соответствует текущая запрошенная
    ...
    // (например 'list' => ''), поэтому делаем это сами
    ...
    /*
     * Обрабытываем ситуацию, когда переданы некорректные параметры  ELEMENT_ID,
    ...
    elseif (isset($arVariables['ELEMENT_CODE']) && strlen($arVariables['ELEMENT_CODE']) > 0)
        ...
        $componentPage = 'list'; // главная страница компонента
